...
THREE.OrbitControls = function ( object, domElement ) {
	...
	// How far you can pan
	this.minPanX = -Infinity;
	this.maxPanX = Infinity;
	this.minPanY = -Infinity;
	this.maxPanY = Infinity;
	this.minPanZ = -Infinity;
	this.maxPanZ = Infinity;
	...
	this.update = function () {
		...
		return function update() {
			...
			scope.target.y = Math.max(scope.minPanY, scope.target.y);
			scope.target.y = Math.min(scope.maxPanY, scope.target.y);
			scope.target.z = Math.max(scope.minPanZ, scope.target.z);
			scope.target.z = Math.min(scope.maxPanZ, scope.target.z);
